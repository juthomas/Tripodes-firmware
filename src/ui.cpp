...
void drawSensorsActivity(TFT_eSPI tft, t_sensors sensors, int32_t oscAddress, bool is_upd_sending, bool is_osc_sending)
{
	...
	float gyroscope = map(sqrtf(sensors.gyro.x * sensors.gyro.x + sensors.gyro.y * sensors.gyro.y + sensors.gyro.z * sensors.gyro.z), 0, 37000, 0, 50);
	float acceleration = map(sqrtf(sensors.accel.x * sensors.accel.x + sensors.accel.y * sensors.accel.y + sensors.accel.z * sensors.accel.z), 0, 40, 0, 50);
	...
	float gyro_normal = map(sqrtf(sensors.gyro.x * sensors.gyro.x + sensors.gyro.y * sensors.gyro.y + sensors.gyro.z * sensors.gyro.z), 0, 37000, 0, 100);
	float accel_normal = map(sqrtf(sensors.accel.x * sensors.accel.x + sensors.accel.y * sensors.accel.y + sensors.accel.z * sensors.accel.z), 0, 40, 0, 100);
}
...
void printRunes(TFT_eSprite *drawing_sprite, float alpha)
{
	int16_t space = 10;
	int16_t offset_top = 60;
	int16_t offset_left = 12;
	// ╓▄▄▄▄╫█▄▄▄▄▄▄▄▄▄█▄▄▄▄▄//
	// xxxx xxxx xxxx xxxx//
	...
	// (*drawing_sprite).setCursor(offset_left, offset_top);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 1);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 2);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 3);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 4);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 5);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 6);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 7);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 8);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 9);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 10);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 11);
	// (*drawing_sprite).printf("#### #### #### ####");
	// (*drawing_sprite).setCursor(offset_left, offset_top + space * 12);
	// (*drawing_sprite).printf("#### #### #### ####");
	...
	if (alpha <= 0.6)
	{
		...
		(*drawing_sprite).setCursor(offset_left, offset_top + space * 13);
		(*drawing_sprite).printf("####      #### ####");
		(*drawing_sprite).setCursor(offset_left, offset_top + space * 14);
		(*drawing_sprite).printf("####        ## ####");
		(*drawing_sprite).setCursor(offset_left, offset_top + space * 15);
		(*drawing_sprite).printf("####        ## ####");
	}
	else if (alpha < 0.9)
	{
...
void drawRunes(TFT_eSPI tft, float alpha, bool is_upd_sending, bool is_osc_sending)
{
	...
	drawBatteryLevel(&drawing_sprite, 100, 00, battery_voltage);
	drawing_sprite.setTextColor(TFT_WHITE);
	drawing_sprite.setCursor(0, 10);
	drawing_sprite.setTextColor(TFT_RED);
	drawing_sprite.printf("Alpha   : ");
	drawing_sprite.setTextColor(TFT_WHITE);
	drawing_sprite.printf("%.2f\n\n", alpha);
	drawing_sprite.setTextColor(TFT_WHITE);
	drawing_sprite.setCursor(0, 0);

	printRunes(&drawing_sprite, alpha);
